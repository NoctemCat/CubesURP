...
static class MeshBuilder
{
    ...
    [BurstCompile]
    public struct FillVerticesJobDefer : IJobParallelForDefer
    {
        [ReadOnly]
        public VoxelData Data;
        [ReadOnly]
    ...
    [BurstCompile]
    public struct FillSolidIndicesJobDefer : IJobParallelForDefer
    {
        [ReadOnly]
        public NativeArray<VoxelDataForMesh> SolidFaces;
    ...
    [BurstCompile]
    public struct FillTransparentIndicesJobDefer : IJobParallelForDefer
    {
        [ReadOnly]
        public NativeReference<int> SolidOffset;
        [ReadOnly]
